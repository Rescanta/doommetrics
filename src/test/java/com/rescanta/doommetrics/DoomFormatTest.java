...
public class DoomFormatTest
{
	...
	@Test
	public void predictionReadsAsADashUntilThereIsOne()
	{
		assertEquals("45:00", DoomFormat.prediction(Duration.ofMinutes(45)));
		assertEquals("-", DoomFormat.prediction(null));
	}
